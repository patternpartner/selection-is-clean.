...
- A case with a `if(__vmMode===VM_SOLO){ // SOLO copy, kept as it was` block is one where the solo
  ...
  reverted in #231c on a false premise and reopened in #231d. The only other machine-dependence is context (#231b): op 9's depositor signature and solo strength, op 16's
