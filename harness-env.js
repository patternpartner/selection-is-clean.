...
module.exports.KNOBS = ['MUTUALISM','RQ_TRAIT','GENO_PARASITE','SELF_PREDICT','GRIP_SEED','MEME_TRANSFER','MOTIF_SELECT','FOUND','SELFMODEL','LAW_PERSIST','CHEM','INSCRIBE','CHEM_VERDICT','MUTMAG','AIM','INHERIT','INHERIT_SD','RATION','PROV_BIRTH'];
