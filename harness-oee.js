...
for (const k of ['DIMS_SAT','DIMS_SAT_CAP','DIMS_SAT_OCC','CHAR_DISP','RED_QUEEN','NICHE_BUILD','SPATIAL_NICHE','RQ_TRAIT']) if (process.env[k] !== undefined) globalThis['__' + k] = parseInt(process.env[k], 10);
