...
RIGS=(oee-meter-test.js verb-test.js attention-test.js liveness-report.js harness.js harness-ab.js harness-oee.js harness-strip.js harness-clamp.js harness-stream.js
